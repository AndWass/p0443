...
template <class Sender>
using has_value_types = p0443_v2::is_detected<value_types_detector, Sender>;

template <class Sender>
using has_error_types = p0443_v2::is_detected<error_types_detector, Sender>;

template <class Sender>
using has_sends_done = p0443_v2::is_detected<sends_done_detector, Sender>;
...
template <class Sender, bool NonCvRefed = std::is_same_v<p0443_v2::remove_cvref_t<Sender>, Sender>>
...
struct sender_traits_base<Sender, true>
{
    ...
    template <template <class...> class Tuple, template <class...> class Variant>
    using flattened_value_type = typename p0443_v2::detail::flattened_value_type<value_types<Tuple, Variant>>::type;
...
template <class Sender>
struct sender_traits_base<Sender, false> : sender_traits_base<p0443_v2::remove_cvref_t<Sender>>
{};
...
struct function_result_types_helper
{
    ...
    template<class Sender>
    using sender_value_types = typename p0443_v2::sender_traits<Sender>::template value_types<std::tuple, Variant>;
