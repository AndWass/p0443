...
struct has_tag_invoke_member_function
    : ::p0443_v2::is_detected<detail::tag_invoke_member_detector, Class, Tag, Args...>
{};
...
struct has_tag_invoke_free_function
    : ::p0443_v2::is_detected<detail::tag_invoke_free_function_detector, Class, Tag, Args...>
{};
...
struct is_executor_of_impl
    : std::conjunction<std::is_invocable<Function>, std::is_nothrow_copy_constructible<Executor>,
                       ...
                       p0443_v2::has_tag_invoke<Executor, p0443_v2::tag::execute_t, Function>>
{};
...
struct is_executor : p0443_v2::detail::is_executor_of_impl<Executor, detail::archetype_invocable>
{};

template <class Executor, class Function>
struct is_executor_of : p0443_v2::detail::is_executor_of_impl<Executor, Function>
{};
...
struct is_receiver : std::conjunction<std::is_move_constructible<remove_cvref_t<T>>,
                                      ...
                                      has_tag_invoke<T &&, ::p0443_v2::tag::set_done_t>,
                                      has_tag_invoke<T &&, ::p0443_v2::tag::set_error_t, E &&>>
{};

template <class T, class... Vs>
struct is_receiver_of
    : std::conjunction<is_receiver<T>, has_tag_invoke<T, ::p0443_v2::tag::set_value_t, Vs...>>
{};
